...
import pytest
from deluge_compat import run_deluge_script, Map, List, DelugeString
...
class TestWorkingFeatures:
    ...
    def test_data_types_creation_and_methods(self):
        ...
        l.add("cherry")
        assert l.size() == 3
        assert l.get(1) == "banana"
        assert l.indexOf("cherry") == 2
    ...
    def test_encoding_decoding_functions(self):
        ...
        from deluge_compat.functions import (
            base64Encode, base64Decode, encodeUrl, urlDecode,
            aesEncode, aesDecode
        )
    ...
    def test_mathematical_functions(self):
        ...
        from deluge_compat.functions import (
            abs_func, min_func, max_func, power_func, sqrt_func,
            ceil_func, floor_func, round_func, randomNumber
        )
        import math
    ...
    def test_error_handling_graceful(self):
        ...
        l = List()
        assert l.get(999) is None  # Out of bounds returns None
